"""
Django settings for wastenot_proj project.
...
ROOT_URLCONF = 'wastenot_proj.urls'
...
WSGI_APPLICATION = 'wastenot_proj.wsgi.application'
...
EMAIL_HOST_USER = env.get("EMAIL_HOST")
